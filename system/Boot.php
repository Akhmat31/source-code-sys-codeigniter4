...
class Boot
{
    ...
    {
        if (is_file(ROOTPATH . '/config/Boot/' . ENVIRONMENT . '.php')) {
            require_once ROOTPATH . '/config/Boot/' . ENVIRONMENT . '.php';
    ...
    protected static function loadAutoloader(): void
    {
        if (! class_exists(Autoload::class, false)) {
            ...
            require_once ROOTPATH . 'config/Modules.php';
        }

        require_once SYSTEMPATH . 'Autoloader/Autoloader.php';
        require_once SYSTEMPATH . 'Config/BaseService.php';
        require_once SYSTEMPATH . 'Config/Services.php';
        require_once ROOTPATH . 'config/Services.php';
